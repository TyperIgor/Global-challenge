...
{
    internal class DeviceOperation(IDeviceImpBusiness deviceCRUD) : IDevicesOperation
    {
        private readonly IDeviceImpBusiness _deviceCRUD = deviceCRUD ?? throw new ArgumentNullException(nameof(deviceCRUD));
