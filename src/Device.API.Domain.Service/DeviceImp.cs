...
{
    internal class DeviceImp(IDeviceRepository deviceRepository, ILogger<DeviceImp> logger) : IDeviceImp // In this domain service class, i can use multiple repositories if needed and apply domain business rules
    {
